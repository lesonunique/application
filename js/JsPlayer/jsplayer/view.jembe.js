...
var JsPlayerJembeView = Backbone.View.extend({
    ...
    initialize:function () {
        ...
        _.bindAll(this, 'onAudioCanPlay', 'onAudioPlay', 'onAudioPause', 'onAudioPlaying', 'onAudioWaiting', 'onAudioTimeUpdate', 'onAudioEnded', 'onAudioError', 'onAudioDurationChange', 'onAudioBuffering', 'onAudioVolumeChange', 'mute', 'mute2', 'onAudioVolumeChange2');
