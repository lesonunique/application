<?php  header("Access-Control-Allow-Origin: *");
	...
	$mail->Subject="Message envoyé depuis l'application SUN RADIO ".date('d/m/Y')." à ".date('G:i');
	$mail->Body ='	Bonjour,
					<p>Message envoyé le '.date('d/m/Y').' à '.date('G:i').' depuis l\'application SUN RADIO</p>
